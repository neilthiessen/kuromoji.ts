...
describe("DictionaryBuilder", function () {
  ...
  var kuromoji_dic: DynamicDictionaries | null = null; // target object of DynamicDictionaries to build
  ...
  test("Dictionary not to be null", function () {
    expect(kuromoji_dic).not.to.be.null;
  });
  test("TokenInfoDictionary not to be null", function () {
    if (kuromoji_dic === null) throw new Error("kuromoji_dic is null");
    expect(kuromoji_dic.token_info_dictionary).not.to.be.null;
  });
  test("TokenInfoDictionary", function () {
    if (kuromoji_dic === null) throw new Error("kuromoji_dic is null");
  ...
  test("DoubleArray not to be null", function () {
    if (kuromoji_dic === null) throw new Error("kuromoji_dic is null");
    expect(kuromoji_dic.trie).not.to.be.null;
  });
  test("ConnectionCosts not to be null", function () {
    if (kuromoji_dic === null) throw new Error("kuromoji_dic is null");
    expect(kuromoji_dic.connection_costs).not.to.be.null;
  });
  test("Tokenize simple test", function () {
    if (kuromoji_dic === null) throw new Error("kuromoji_dic is null");
