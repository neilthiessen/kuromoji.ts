...
const { builder, load }: { builder: any; load: DoubleArrayLoadFunction } =
  doublearray;
...
import { DoubleArray, DoubleArrayLoadFunction, AnyIntArray } from "../types";
...
class DynamicDictionaries {
  ...
  constructor(
    ...
    // console.log("DynamicDictionaries constructor");
    if (trie != null) {
      this.trie = trie;
    } else {
  ...
  loadTrie(base_buffer: AnyIntArray, check_buffer: AnyIntArray) {
